<template>
  <section class="py-16 bg-white">
    ...
    <div class="max-w-screen-lg mx-auto flex flex-col-reverse md:flex-row items-center gap-12">
      <!-- Texte -->
    ...
    <div class="max-w-screen-lg mx-auto text-center mt-12 px-4">
      <p class="text-base md:text-lg leading-relaxed mb-6">
        ...
        Nous travaillons la fleur comme une matière brute, sensible, à la frontière de l’art.<br/>
